...
<div class="container" id="A">
    ...
    <div class="row m-3 border border-secondary rounded">
        ...
        <a class= "col-4 " href={{ route("name.info", [ "type" => "Firstname", "id" => $name->ID ]) }} >
            <button class="col-4 px-2 py-3 btn btn-light text-left">{{ $name->Firstname }}</button>
        </a>
        @endforeach
    </div>
</div>
